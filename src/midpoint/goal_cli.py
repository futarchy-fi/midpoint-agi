...
def analyze_goal(goal_id, human_mode=False):
    ...
    # Delegate to the dedicated command module (parallel to decompose/execute/validate).
    from .goal_analysis import analyze_goal as analyze_goal_cmd

    return analyze_goal_cmd(goal_id, human_mode=human_mode)
