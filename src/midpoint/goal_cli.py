...
# All CLI logic has been moved to goal_commands.py and supporting modules.
# This file now only serves as a minimal entry point.

if __name__ == "__main__":
    from .goal_commands import main
    main() 