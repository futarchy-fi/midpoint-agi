#!/usr/bin/env python
"""
Example script demonstrating the GoalDecomposer in action using the local config.json file.
...
async def main():
    """Run the example with the local config."""
    print("GoalDecomposer Example with Local Config\n")
